  ...
  <div class="admin-content">
    <div class="admin-content-body">
      ...
      <ul class="am-avg-sm-1 am-avg-md-4 am-margin am-padding am-text-center admin-content-list ">
        <li><a href="/admin/category" class="am-text-success"><span class="am-icon-btn am-icon-file-text"></span><br/>分类管理</a></li>
        <li><a href="/admin/urls" class="am-text-warning"><span class="am-icon-btn am-icon-briefcase"></span><br/>网址管理</a></li>
        <li><a href="/admin/website" class="am-text-danger"><span class="am-icon-btn am-icon-recycle"></span><br/>网站设置</a></li>
        <li><a href="/admin/visitor" class="am-text-secondary"><span class="am-icon-btn am-icon-user-md"></span><br/>访问量<#if visitor ??><br>${visitor}</#if></a></li>
      </ul>
