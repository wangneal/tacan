  ...
  <div class="admin-content">
    <div class="admin-content-body">
      <div class="am-cf am-padding">
        <div class="am-fl am-cf"><strong class="am-text-primary am-text-lg">首页</strong> / <small>网站设置</small></div>
      </div>
        <#if msg ??>
        ...
        <form action="/admin/website" method="post" class="am-form">
            <label for="username">网站名称:</label>
            <input type="text" name="webname" id="username" value="${website.webname}">
            <br>
            <label for="password">网站域名:</label>
            <input type="text" name="webdescribe" id="username" value="${website.webdescribe}">
            <br/>
            <div class="am-cf">
