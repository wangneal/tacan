  ...
  <div class="admin-content">
    <div class="admin-content-body">
      <div class="am-cf am-padding">
        <div class="am-fl am-cf"><strong class="am-text-primary am-text-lg">首页</strong> / <small>分类编辑</small></div>
      </div>
        <#if msg ??>
        ...
        <#if category ??>
        <form action="/admin/update" method="post" class="am-form">
            <label for="username">序号:</label>
            <input type="text" name="id" id="username" value="${category.id}">
            <br>
            <label for="password">名称:</label>
            <input type="text" name="name" id="password" value="${category.name}">
            <br/>
            <div class="am-cf">
