  ...
  <div class="admin-content">
    <div class="admin-content-body">
      <div class="am-cf am-padding">
        ...
        <form action="/admin/urlsupdate" method="post" class="am-form">
            <label for="username">网站名称:</label>
            <input type="text" name="sitename"  value="${urlsite.sitename}">
            <br/>
            <label for="username">网站URL:</label>
            <input type="text" name="siteurl"  value="${urlsite.siteurl}">
            <br/>
            <label for="username">审核状态:
            <input type="radio" name="status"  value="1" checked>审核 |
                <input type="radio" name="status"  value="0">不审核
            </label>
            <br>
